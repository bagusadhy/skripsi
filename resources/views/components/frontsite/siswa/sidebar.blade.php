    ...
    <div class="flex justify-between gap-10 flex-col lg:flex-row">
        ...
        <nav id="sidenav"
            ...
            <ul class="relative m-0 list-none px-[0.2rem]" data-te-sidenav-menu-ref>
                ...
                <li class="relative">
                    <a href="{{ route('siswa.mitra.index') }}"
                        class="flex h-12 cursor-pointer items-center truncate rounded-[5px] px-4 py-4 text-[0.875rem] font-medium text-gray-600 outline-none transition duration-300 ease-linear hover:bg-slate-200 hover:text-inherit hover:outline-none focus:bg-slate-50 focus:text-inherit focus:outline-none active:bg-slate-50 active:text-inherit active:outline-none data-[te-sidenav-state-active]:text-inherit data-[te-sidenav-state-focus]:outline-none motion-reduce:transition-none dark:text-gray-300 dark:hover:bg-white/10 dark:focus:bg-white/10 dark:active:bg-white/10 {{ request()->is('siswa/mitra') || request()->is('siswa/mitra/*') ? 'bg-slate-300 font-bold' : '' }}"
                        data-te-sidenav-link- ref>
