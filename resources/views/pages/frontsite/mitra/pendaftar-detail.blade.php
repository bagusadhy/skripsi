        ...
        <div class="sm:px-6 mb-10">
            <div class="py-4 md:py-7">
                <div tabindex="0"
                    ...
                    <a href="{{ route('mitra.pendaftar.index') }}" class="flex items-center">
            ...
            <div class="mt-5">
                <div class="py-2">
                    <ul class="list-none w-34">
                        <li class="mb-5 flex">
                            <div class="w-32 md:w-44 flex justify-between"><span>Lowongan</span>
                                <pre class="block">: </pre>
                            </div>
                            <div class="w-4/6 md:w-5/6">
                                <p>{{ $pendaftar->lowongan->nama }}</p>
                            </div>
                        </li>
                        <li class="mb-5 flex">
                        ...
                        <li class="mb-5 flex">
                            ...
                            <div class="w-4/6 md:w-5/6">
                                <p>{{ $pendaftar->siswa->jurusan->jurusan }}</p>
                            </div>
                        </li>
                        <li class="mb-5 flex">
                            ...
                            <div class="w-4/6 md:w-5/6">
                                <p>{{ $pendaftar->siswa->kelas->kelas }}</p>
                            </div>
                        </li>
                        <li class="mb-5 flex">
                            ...
                            <div class="w-4/6 md:w-5/6">
                                @if ($pendaftar->siswa->jenis_kelamin == '1')
                                    <p>Laki-laki</p>
                                @else
                                    <p>Perempuan</p>
                                @endif
                        ...
                        <li class="mb-5 flex">
                            ...
                            <div class="w-4/6 md:w-5/6">
                                <p>{{ $pendaftar->siswa->tempat_lahir . ', ' . date('d M Y', strtotime($pendaftar->siswa->tanggal_lahir)) }}</p>
                            </div>
                        </li>
                        <li class="mb-5 flex">
                            ...
                            <div class="w-4/6 md:w-5/6">
                                <p class="text-justify">{{ $pendaftar->siswa->agama }}</p>
                            </div>
                        </li>
                        <li class="mb-5 flex">
                            ...
                            <div class="w-4/6 md:w-5/6">
                                <p class="text-justify">{{ $pendaftar->siswa->kontak }}</p>
                            </div>
                        </li>
                        <li class="mb-5 flex">
                            ...
                            <div class="w-4/6 md:w-5/6">
                                <p class="text-justify">{{ $pendaftar->siswa->alamat }}</p>
                            </div>
                        </li>
                    </ul>
                </div>
