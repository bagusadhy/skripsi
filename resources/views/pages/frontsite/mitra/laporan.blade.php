                        ...
                        <tbody class="overflow-x-scroll">
                            @forelse ($laporan as $data)
                                <tr data-entry-id="{{ $data->siswa_id }}" class="hover:bg-neutral-200 outline-2">
                                    ...
                                    <td class="whitespace-nowrap">{{ date('d-m-Y', strtotime($data->created_at)) }}</td>
                                    <td class="whitespace-nowrap">
                                        <a class="block w-32 px-3 py-2  whitespace-nowrap text-center text-white text-xs font-medium uppercase leading-normal rounded bg-blue-700"
                                            href="{{ route('mitra.laporan.download', $data->siswa_id) }}">
                                            Download
                                        </a>
                                    </td>
                                </tr>
