            ...
            <div class="mt-10">
                <div class="flex flex-wrap justify-start gap-10 w-fit">
                    <div
                        ...
                        <div class="w-24">
                            <p class="text-sm font-medium text-gray-400">Total Siswa PKL</p>
                    ...
                    <div
                        ...
                        <div class="w-24">
                            <p class="text-sm font-medium text-gray-400">Total Pendaftar</p>
                            <p class="font-extrabold text-2xl text-[#009E3D]">{{ $pendaftar->total_pendaftar }}</p>
                        </div>
                    </div>
