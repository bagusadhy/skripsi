...
@section('content')
    <main class="basis-10/12 bg-white min-h-fit px-10 py-5  overflow-x-hidden">
        ...
        <div class="sm:px-6 mb-10">
            ...
            <form action="{{ route('mitra.profile.update', $mitra->id) }}" method="POST" class="mt-5"
                ...
                <div class="w-fit mb-10">
                    <label for="input-pic" class="flex gap-10 items-center">
                        ...
                        @else
                            <img src="{{ asset('storage/' . $mitra->foto) }}" id="profil-circle"
                ...
                <div class="flex justify-between flex-col lg:flex-row lg:gap-10 lg:mb-3">
                    <div class="mb-3 w-full">
                        ...
                        <input type="text"
                            ...
                            name="nama" id="nama" required value="{{ $mitra->nama }}"></input>
                        @if ($errors->has('nama'))
                    ...
                    <div class="mb-3 w-full">
                        ...
                        <input type="number"
                            ...
                            name="kontak" id="kontak" required value="{{ $mitra->kontak }}"></input>
                ...
                <div class="flex justify-between flex-col lg:flex-row lg:gap-10 lg:mb-3">
                    ...
                    <div class="mb-3 w-full">
                        ...
                        <input type="text"
                            class="w-full h-11 rounded-md border border-gray-300 px-5 py-3 focus:outline-none resize-none"
                            name="nama_pimpinan" id="nama_pimpinan" required value="{{ $mitra->nama_pimpinan }}"></input>
                    ...
                    <div class="mb-3 w-full">
                        ...
                        <input type="text"
                            ...
                            value="{{ $mitra->nama_pembimbing }}"></input>
                        ...
                        <select data-te-select-init data-te-select-placeholder="Pilih Bidang Usaha" name="bidang_usaha_id"
                            ...
                            @foreach ($bidang_usaha as $items)
                                <option value="{{ $items->id }}"
                                    {{ $mitra->bidang_usaha_id == $items->id ? 'selected' : '' }}>
                                    {{ $items->title }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="flex justify-between flex-col lg:flex-row lg:gap-10 lg:mb-3">
                    <div class="mb-3 w-full">
                        ...
                        <textarea class="w-full h-32 rounded-md border border-gray-300 px-5 py-3 focus:outline-none resize-none"
                            name="alamat" id="alamat" required>{{ $mitra->alamat }}</textarea>
