...
@section('content')
    <main class="basis-10/12 bg-white min-h-fit px-10 py-5  overflow-x-hidden">
        ...
        <div class="sm:px-6 mb-10">
            ...
            <form action="{{ route('guru.profile.update', $guru->id) }}" method="POST" class="mt-5"
                ...
                <div class="w-fit mb-10">
                    <label for="input-pic" class="flex gap-10 items-center">
                        ...
                        @else
                            <img src="{{ asset('storage/' . $guru->foto) }}" id="profil-circle"
                ...
                <div class="flex justify-between flex-col lg:flex-row lg:gap-10 lg:mb-3">
                    <div class="mb-3 w-full">
                        ...
                        <input type="text"
                            ...
                            name="nama" id="nama" required value="{{ $guru->nama }}"></input>
                        @if ($errors->has('nama'))
                    ...
                    <div class="mb-3 w-full">
                        <label for="nip" class="block">
                            <span class="font-medium">NIP/NIK<code class="text-red-500">*</code></span>
                        </label>
                        <input type="text"
                            class="w-full h-11 rounded-md border border-gray-300 px-5 py-3 focus:outline-none resize-none"
                            name="nip" id="nip" required value="{{ $guru->nip }}"></input>
                        @if ($errors->has('nip'))
                ...
                <div class="flex justify-between flex-col lg:flex-row lg:gap-10 lg:mb-3">
                        ...
                        <select data-te-select-init data-te-select-placeholder="Pilih Jurusan" name="jurusan_id" required>
                            ...
                            @foreach ($jurusan as $items)
                                <option value="{{ $items->id }}"
                                    {{ $guru->jurusan_id == $items->id ? 'selected' : '' }}>{{ $items->jurusan }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3 w-full">
                        <label for="jenis Kelamin" class="block">
                ...
                <div class="flex justify-between flex-col lg:flex-row lg:gap-10 lg:mb-3">
                    <div class="mb-3 w-full">
                        ...
                        <input type="number"
                            ...
                            name="kontak" id="kontak" required value="{{ $guru->kontak }}"></input>
                ...
                <div class="flex justify-between flex-col lg:flex-row lg:gap-10 lg:mb-3">
                    <div class="mb-3 w-full">
                        ...
                        <textarea class="w-full h-32 rounded-md border border-gray-300 px-5 py-3 focus:outline-none resize-none"
                            name="alamat" id="alamat" required>{{ $guru->alamat }}</textarea>
