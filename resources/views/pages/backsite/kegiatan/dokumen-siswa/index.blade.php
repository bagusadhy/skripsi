                        ...
                        <tbody class="overflow-x-scroll">
                            @foreach ($dokumen as $data)
                                <tr>
                                    ...
                                    <td class="whitespace-nowrap"><a href="{{ url($data->surat_pernyataan_siswa) }}" class="text-blue-500 cursor-pointer">Lihat Dokumen</a></td>
                                    <td class="whitespace-nowrap"><a href="{{ url($data->surat_izin_ortu) }}" class="text-blue-500 cursor-pointer">Lihat Dokumen</a></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
