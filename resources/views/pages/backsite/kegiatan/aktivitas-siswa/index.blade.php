        ...
        <div class="sm:px-6 mb-10">
            ...
            <div class="bg-white py-4 md:py-7 px-4 shadow-md rounded-lg">
                <div class="overflow-x-auto">
                    ...
                    <table id="aktivitas-table" class="stripe">
                        <thead>
                            <tr class="">
                                <th class="whitespace-nowrap">Nama Siswa</th>
                                <th class="whitespace-nowrap">Kelas</th>
                                <th class="whitespace-nowrap">Jurusan</th>
                                <th class="whitespace-nowrap" style="text-align: center !important">Total Presensi & Jurnal</th>
                                <th class="whitespace-nowrap" style="text-align: center !important">Action</th>
                            </tr>
                        </thead>
                        <tbody class="overflow-x-scroll">
                            @forelse ($aktivitas as $data)
                                <tr data-entry-id="{{ $data->siswa_id }}" class="hover:bg-neutral-200 outline-2">
                                    ...
                                    <td class="whitespace-nowrap text-center">{{ $data->total_presensi }}</td>
                                    <td class="whitespace-nowrap flex justify-center">
                                        <a class="block w-32 px-3 py-2  whitespace-nowrap text-center text-xs font-medium uppercase leading-normal text-white rounded bg-blue-700"
                                            href="{{ route('backsite.aktivitas.show', $data->siswa->id) }}"
