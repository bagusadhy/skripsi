        ...
        <div class="sm:px-6 mb-10">
            ...
            <div id="accordionExample" class="shadow-md mb-3 rounded-lg">
                <div class="rounded-lg border border-neutral-200 bg-white px">
                    ...
                    <div id="collapseOne" class="!visible hidden" data-te-collapse-item aria-labelledby="headingOne"
                        ...
                        <div class="px-5 py-4">
                            <form action="{{ route('backsite.template.store') }}" method="POST"
                                ...
                                <label for="laporan" class="block mb-5 cursor-pointer">
                                    <span class="font-medium">Template Laporan<code class="text-red-500">*</code></span>
                                    <div
                                ...
                                <label for="penilaian" class="block mb-5 cursor-pointer">
                                    <span class="font-medium">Template Penilaian<code class="text-red-500">*</code></span>
                                    <div
                                        class="w-full h-40 bg-[#F5F9FC] rounded-md border border-primary border-dashed flex justify-center flex-col items-center">
                                        <div class="flex flex-col items-center" id="penilaian-text">
                                            <span>
                                                <svg width="38" height="38" viewBox="0 0 38 38" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                        ...
                                        <input type="file" class="hidden" id="penilaian" name="penilaian" required>
                                    </div>
                                </label>
            ...
            <div class="bg-white py-4 md:py-7 px-4 shadow-md rounded-lg">
                <div class="overflow-x-auto">
                    ...
                    <table id="template-table" class="stripe">
                        <thead>
                            <tr>
                                <th class="whitespace-nowrap">Jurusan</th>
                                <th class="whitespace-nowrap">Laporan</th>
                                <th class="whitespace-nowrap">Penilaian</th>
                                    ...
                                    <td class="whitespace-nowrap">
                                        <div class="relative" data-te-dropdown-ref>
                                            ...
                                            <ul class="absolute z-[1000] float-left m-0 hidden min-w-max list-none overflow-hidden rounded-lg border-none bg-white bg-clip-padding text-left text-base shadow-lg [&[data-te-dropdown-show]]:block"
                                                ...
                                                <li>
                                                    <form action="{{ route('backsite.template.destroy', $template->id) }}"
                                                        id="form-delete" method="post" data-te-dropdown-item-ref>
                                                        @csrf
                                                        @method('delete')
                                                        <button type="submit"
                                                            class="delete-confirm block w-full whitespace-nowrap bg-transparent px-16 py-2 text-sm font-normal hover:bg-neutral-200">Hapus</button>
                                                    </form>
                                                </li>
                                            </ul>
                                        </div>
...
@push('after-script')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var penilaianText = document.getElementById('penilaian-text')
            penilaian.addEventListener('change', function() {
                if (this.files.length) {
                    penilaianText.innerText = this.files[0].name;
                }
            });
